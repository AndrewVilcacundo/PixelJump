...
El jugador controla a un personaje que debe saltar entre plataformas, **evitar caer** y **recoger estrellas** hasta llegar al final del nivel, donde encontrará una **bandera o portal de meta**.
...
- **Audio Clips (.mp3)** para efectos de sonido
